...
export default function Slide00Cover() {
  const stats = [
    ["Nov 2024", "Pertama dirilis"],
    ["Growing Ecosystem", "Server & tool terus bertambah"],
    ["Open Standard", "Dikembangkan oleh Anthropic"],
  ];
  const pairingCode = "777777";
      ...
      <div className="mx-auto max-w-5xl text-center">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-3 md:mt-12 md:gap-4">
          {stats.map(([value, label]) => (
            <div key={value} className="deck-surface rounded-lg border border-[#234879] px-4 py-4 sm:px-5 md:px-6">
