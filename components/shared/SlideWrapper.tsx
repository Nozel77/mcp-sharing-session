...
export function SlideWrapper({ children }: { children: ReactNode }) {
  return (
    <section className="relative flex h-dvh flex-col items-center justify-start overflow-hidden bg-[#07101f] px-4 pb-28 pt-8 sm:px-6 md:justify-center md:px-10 md:pb-24 md:pt-10 lg:px-16 xl:px-24">
