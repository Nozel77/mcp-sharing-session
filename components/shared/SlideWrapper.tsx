...
export function SlideWrapper({ children }: { children: ReactNode }) {
  return (
    <section className="relative flex min-h-dvh flex-col items-center justify-start overflow-x-hidden bg-[#07101f] px-4 pb-28 pt-8 sm:px-6 md:justify-center md:px-10 md:pb-24 md:pt-10 lg:px-16 xl:px-24">
